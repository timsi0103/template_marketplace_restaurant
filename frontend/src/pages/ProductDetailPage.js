    ...
    <div data-testid="product-detail-page" className="min-h-screen">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 font-body text-sm text-brand-text-secondary hover:text-brand-text transition-colors mb-6"
        >
        ...
        <div
          ...
          className="relative rounded-2xl overflow-hidden mb-8 aspect-[16/8] bg-brand-bg"
        >
          <img
            src={product.image}
            alt={product.name}
        ...
        {/* Tags */}
        <div data-testid="product-tags" className="flex flex-wrap gap-2 mb-4">
          {product.tags.map((tag) => (
            <span
              key={tag}
              className={`px-3 py-1 text-[10px] font-body font-semibold uppercase tracking-wider rounded ${
        ...
        <p
          ...
          className="font-heading text-2xl font-bold text-brand-primary mt-1"
        >
          ${product.price.toFixed(2)}
        </p>

        {/* Quantity + Add to Order */}
        <div data-testid="product-actions" className="flex items-center gap-4 mt-6">
        ...
        {/* Enhancements */}
        <div data-testid="enhancements-section" className="mt-10">
          <h2 className="font-heading text-xl font-bold text-brand-text mb-4">
            Enhancements
          </h2>
          <div className="bg-brand-surface border border-brand-border rounded-xl divide-y divide-brand-border">
            {product.enhancements.map((enh) => (
              <label
                ...
                className="flex items-center justify-between p-4 cursor-pointer hover:bg-brand-bg/50 transition-colors"
              >
        ...
        <div data-testid="special-instructions-section" className="mt-8 mb-12">
          <h2 className="font-heading text-xl font-bold text-brand-text mb-4">
            Special Instructions
          </h2>
          <Textarea
            ...
            className="bg-brand-bg border-brand-border font-body text-sm resize-none min-h-[100px] placeholder:text-brand-text-secondary/60"
          />
        </div>
      </div>
    </div>
