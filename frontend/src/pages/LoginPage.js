...
const DEMO_ACCOUNTS = [
  {
    ...
    email: process.env.REACT_APP_DEMO_ADMIN_EMAIL || "admin@culinaryeditorial.com",
    password: process.env.REACT_APP_DEMO_ADMIN_PASSWORD || "Admin123!",
    redirect: "/admin",
    icon: Sparkles,
  ...
  },
  {
    ...
    email: process.env.REACT_APP_DEMO_CUSTOMER_EMAIL || "demo@culinaryeditorial.com",
    password: process.env.REACT_APP_DEMO_CUSTOMER_PASSWORD || "Demo123!",
    redirect: "/menu",
    icon: UserIcon,
        ...
        <div className="bg-brand-surface border border-brand-border rounded-2xl p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              type="button"
              onClick={() => toast.info("Apple Sign-In is coming soon", { description: "Use email or Google sign-in for now." })}
              className="w-full flex items-center justify-center gap-3 py-2.5 bg-brand-surface border border-brand-border rounded-full font-body text-sm font-medium text-brand-text hover:bg-brand-bg transition-colors"
            >
            ...
            <button
              ...
              type="button"
              onClick={() => toast.info("Facebook Sign-In is coming soon", { description: "Use email or Google sign-in for now." })}
              className="w-full flex items-center justify-center gap-3 py-2.5 bg-brand-surface border border-brand-border rounded-full font-body text-sm font-medium text-brand-text hover:bg-brand-bg transition-colors"
            >
