  ...
  return (
    <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
      <DrawerContent
        ...
        className="bg-brand-surface border-brand-border max-h-[85vh]"
      >
        <DrawerHeader className="text-left px-5 pt-4 pb-2">
          <DrawerTitle className="font-heading text-xl font-bold text-brand-text flex items-center gap-2">
            ...
            Your Cart
            {itemCount > 0 && (
              <span className="ml-1 px-2 py-0.5 text-[10px] font-body font-semibold bg-brand-primary text-white rounded-full">
                {itemCount}
              </span>
            )}
          </DrawerTitle>
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="font-heading text-sm font-semibold text-brand-primary mt-0.5">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <div className="inline-flex items-center border border-brand-border rounded-full">
                        ...
                        <span
                          data-testid={`cart-qty-val-${item.id}`}
                      ...
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center text-brand-text-secondary hover:text-red-500 active:text-red-600 transition-colors"
                      >
                        <Trash2 size={14} />
                      </button>
                    </div>
          ...
          <DrawerFooter className="px-5 pb-5 pt-3 border-t border-brand-border">
            <div className="flex justify-between items-center mb-3">
              ...
              <span
                ...
                className="font-heading text-xl font-bold text-brand-text"
              >
                ${subtotal.toFixed(2)}
              </span>
            </div>
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-4 bg-brand-primary text-white font-body text-sm font-semibold rounded-full hover:bg-brand-primary-hover active:scale-[0.98] transition-all"
            >
